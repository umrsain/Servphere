          ...
          <Container style={container}>
            ...
            <Section style={{ paddingBottom: "20px" }}>
              <Row>
                ...
                <div className="p-5 w-3/4 rounded-lg border border-gray-200">
                ...
                <div className="p-5 w-3/4 mt-5 rounded-lg border border-gray-200">
                    <Text style={{ ...paragraph, fontWeight: "700", fontSize: "20px" }}>
                        Cancellation policy              
                    </Text>

                    <Text style={{...paragraph,fontSize: "17px"}}>
                     Appointments must be cancelled online at least 1 hour prior to the start time. Failure to do so will result in a charge of the full service missed.                   
                    </Text>
                </div>
                ...
                <div className="p-5 w-3/4 mt-5 rounded-lg border border-gray-200">
                    ...
                    <Text style={{...paragraph,fontSize: "17px"}}>
                        View your booking to reschedule or cancel your appointment.
                    </Text>

                    <Text style={{...paragraph,fontSize: "17px",color:'cornflowerblue'}}>
                        View booking
                    </Text>
                </div>
              </Row>
