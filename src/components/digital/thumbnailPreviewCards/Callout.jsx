...
const Callout = ({img,title, subtitle, price, buttonCTA}) => {
...
// Check if global URL exists otherwsise set it the local state variable
  ...
  return (
    <div className='flex w-2/4 items-start justify-center'>
        ...
        <div className="flex flex-col sticky top-20 items-center justify-center bg-[#f9f9f9] rounded-md drop-shadow-xl w-[70%] h-[30%]">
            <div className='bg-white w-[92%] h-[73%]'>
                ...
                <div className='flex flex-col space-y-4 items-center justify-center'>
                    ...
                    <button className='bg-sky-500/75 hover:bg-sky-300 py-2 w-11/12 rounded focus:outline-none focus:shadow-outline'>
